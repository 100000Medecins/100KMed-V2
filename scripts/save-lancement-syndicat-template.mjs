...
//
// Placeholders remplis par syndicat : {{nom_syndicat}} {{logo_syndicat}} {{citation}}
...
const LINK = `${S}/?utm_source={{utm_source}}&utm_medium=email&utm_campaign=lancement-2026`
    ...
    <table cellpadding="0" cellspacing="0" style="max-width:580px;width:100%;">
      ...
      <tr>
        <td style="padding:0 0 20px;">
          <a href="${LINK}" style="text-decoration:none;display:block;line-height:0;">
                ...
                <div style="margin:24px 0;background:#F4F6FB;border-radius:14px;padding:24px 26px;">
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" style="border-top:1px solid #e2e8f0;">
                    <tr><td style="padding-top:14px;">
                      <p style="margin:0;font-size:13px;font-weight:700;color:#0f1e38;">{{president_nom}}</p>
                      <p style="margin:3px 0 0;font-size:12px;color:#94a3b8;">{{president_fonction}}</p>
                    </td></tr>
                  </table>
                </div>
                ...
                <table cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="background:#0f1e38;border-radius:12px;">
                      <a href="${LINK}" style="display:inline-block;padding:14px 26px;font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;white-space:nowrap;">Découvrir la plateforme&nbsp;→</a>
                    </td>
                  </tr>
                </table>
      ...
      <tr>
        <td style="padding:22px 6px 18px;">
          <p style="margin:0;font-size:11px;color:rgba(255,255,255,0.40);line-height:1.7;text-align:center;">
            Vous recevez ce message en tant qu'adhérent ou sympathisant de {{nom_syndicat}}. Plusieurs organisations soutiennent 100&nbsp;000 Médecins : si vous le recevez plusieurs fois, merci de votre indulgence — c'est le signe d'une mobilisation large de la profession.
          </p>
        </td>
      </tr>
      ...
      <tr>
        <td style="text-align:center;border-top:1px solid rgba(255,255,255,0.08);padding:18px 0 0;">
          <a href="${LINK}" style="display:inline-block;text-decoration:none;line-height:0;">
          ...
          <p style="margin:8px 0 0;font-size:11px;color:rgba(255,255,255,0.45);">Cet email vous est adressé par {{nom_syndicat}}.</p>
        </td>
      </tr>
...
console.log('   Placeholders : {{nom_syndicat}} {{logo_syndicat}} {{citation}} {{president_nom}} {{president_fonction}} {{utm_source}}')
