...
import { Bell, RefreshCw, Mail, CheckCircle, FlaskConical, BookOpen, ArrowRight } from 'lucide-react'
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-xs text-emerald-600 font-medium">avec le Digital Medical Hub</span>
                </div>
                <p className="text-xs text-gray-500 mt-0.5 max-w-sm">
