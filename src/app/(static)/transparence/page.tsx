...
export default async function TransparencePage() {
  // Pas de fallback hardcodé : le contenu de transparence vit en BDD (pages_statiques).
  // Si la requête échoue, on laisse Next servir error.tsx plutôt que d'afficher
  // une version périmée (le contenu hardcodé datait de 2023). Cf. decision 2026-05-31.
  const dbPage = await getPageBySlug('transparence')
