...
import { ClipboardCheck, Heart, Settings, LogOut, UserCircle } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/mon-compte/mes-favoris', label: 'Mes favoris', icon: Heart },
  { href: '/mon-compte/mes-preferences', label: 'Mes préférences', icon: Settings },
]
