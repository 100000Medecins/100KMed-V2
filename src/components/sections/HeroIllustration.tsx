...
function floatStyle(key: FloatKey): CSSProperties {
  const f = FLOATS[key]
  return {
    '--y-from': `${f.y[0]}px`,
    '--y-to':   `${f.y[1]}px`,
    '--r-from': `${f.baseR - f.r}deg`,
    '--r-to':   `${f.baseR + f.r}deg`,
    animation: `hero-float ${f.dur}s ease-in-out ${f.delay}s infinite alternate both`,
  } as CSSProperties
}
  ...
  return (
    <div className="relative w-[420px] h-[320px]">
      ...
      <div className="absolute top-[48px] left-[4px]">
        <div
          style={{ ...floatStyle('leftCard'), background: 'rgba(255,255,255,0.08)' }}
      ...
      <div className="absolute top-[42px] right-[4px]">
        <div
          style={{ ...floatStyle('rightCard'), background: 'rgba(255,255,255,0.08)' }}
      ...
      <div className="absolute top-[82px] left-1/2 -translate-x-1/2 z-20">
        <div
          style={{ ...floatStyle('centralCard'), background: 'rgba(255,255,255,0.15)' }}
      ...
      {nbSolutionsLabel && (
        <div className="absolute bottom-[55px] right-[6px] z-30">
          <div style={floatStyle('badgeSolutions')}
      ...
      {nbEvaluationsLabel && (
        <div className="absolute bottom-[28px] left-[100px] z-30">
          <div style={floatStyle('badgeAvis')}
      ...
      {nbInscritsLabel && (
        <div className="absolute top-[68px] left-1/2 -translate-x-1/2 z-30">
          <div style={floatStyle('badgeInscrits')}
      ...
      <div className="absolute bottom-[52px] left-[6px] z-20">
        <div
          style={{ ...floatStyle('citation'), background: 'rgba(255,255,255,0.09)' }}
