    ...
    <section className="bg-hero-gradient pt-[72px]">
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h1
              className="text-4xl md:text-5xl lg:text-[3.4rem] font-extrabold text-navy leading-[1.15] tracking-tight [&_p]:m-0 [&_br]:block"
              dangerouslySetInnerHTML={{ __html: heroTitre }}
            />
            <div
              className="mt-5 text-gray-600 text-base md:text-lg leading-relaxed max-w-lg [&_p]:m-0"
          ...
          <div className="hidden lg:flex items-center justify-center">
            {heroImage ? (
              <img
                ...
                className="w-[420px] h-[340px] object-cover rounded-3xl shadow-card"
              />
            ) : (
